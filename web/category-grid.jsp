...
<html lang="en">
    ...
    <script>
        ...
        function changeFunc() {
            ...
            window.location = 'SearchProduct?target=/category-grid.jsp&searchBy=${param.searchBy}&type=${param.type}&'+
                ...
                <div class="col-md-9">
                    ...
                    <div class="product-filter">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="display">
                                    <a href="category-list.jsp?searchBy=${param.searchBy}&type=${param.type}&
